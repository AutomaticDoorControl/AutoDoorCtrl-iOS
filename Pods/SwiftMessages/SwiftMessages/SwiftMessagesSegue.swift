...
extension SwiftMessagesSegue {
    ...
    public func configure(layout: Layout) {
        ...
        switch layout {
        case .topMessage:
            messageView.layoutMarginAdditions = UIEdgeInsets.init(top: 20, left: 20, bottom: 20, right: 20)
        ...
        case .topCard:
            ...
            messageView.layoutMarginAdditions = UIEdgeInsets.init(top: 10, left: 10, bottom: 10, right: 10)
        ...
        case .topTab:
            ...
            messageView.layoutMarginAdditions = UIEdgeInsets.init(top: 20, left: 10, bottom: 20, right: 10)
            messageView.collapseLayoutMarginAdditions = true
            containerView.cornerRadius = 15
